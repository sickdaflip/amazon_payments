...
class Creativestyle_AmazonPayments_Model_Api_Pay
{
    ...
    {
        $this->_getApi($store)->confirmOrderReference(
            array(
                'amazon_order_reference_id' => $orderReferenceId,
            )
        );
    ...
    {
        $this->_getApi($store)->cancelOrderReference(
            array(
                'amazon_order_reference_id' => $orderReferenceId,
    ...
    {
        $this->_getApi($store)->closeOrderReference(
            array(
                'amazon_order_reference_id' => $orderReferenceId,
    ...
    {
        $this->_getApi($store)->setOrderAttributes(
            array(
                'amazon_order_reference_id'         => $orderReferenceId,
